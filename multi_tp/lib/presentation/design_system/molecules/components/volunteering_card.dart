...
class VolunteeringCard extends ConsumerWidget {
  const VolunteeringCard({Key? key, required this.id}) : super(key: key);
  final String id;

  void Function() _handleVolunteering(BuildContext context, WidgetRef ref) {
    return () {
      ref.read(mainBeamerDelegateProvider).beamToNamed(SingleVolunteeringScreen.routeFromId(id));
    };
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return InkWell(
      onTap: _handleVolunteering(context, ref),
      child: Container(
