...
class SingleVolunteeringScreen extends ConsumerStatefulWidget {
  ...
  const SingleVolunteeringScreen({Key? key, required this.id}) : super(key: key);
  final String id;

  @override
  ConsumerState<SingleVolunteeringScreen> createState() => _SingleVolunteeringScreenState();
}

class _SingleVolunteeringScreenState extends ConsumerState<SingleVolunteeringScreen> {
  int _freeSpaces = 0;
  bool _applied = false;
